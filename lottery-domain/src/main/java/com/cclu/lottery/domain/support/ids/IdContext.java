...
import com.cclu.lottery.domain.support.ids.policy.RandomNumeric;
import com.cclu.lottery.domain.support.ids.policy.ShortCode;
import com.cclu.lottery.domain.support.ids.policy.SnowFlake;
...
public class IdContext {
    ...
    public Map<Constants.Ids, IIdGenerator> idGenerator(SnowFlake snowFlake, ShortCode shortCode, RandomNumeric randomNumeric) {
        Map<Constants.Ids, IIdGenerator> idGeneratorMap = new HashMap<>(4);
