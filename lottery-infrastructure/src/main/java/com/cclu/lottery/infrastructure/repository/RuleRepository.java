...
import com.cclu.lottery.infrastructure.dao.RuleTreeDao;
import com.cclu.lottery.infrastructure.dao.RuleTreeNodeDao;
import com.cclu.lottery.infrastructure.dao.RuleTreeNodeLineDao;
import com.cclu.lottery.infrastructure.po.RuleTree;
import com.cclu.lottery.infrastructure.po.RuleTreeNode;
...
public class RuleRepository implements IRuleRepository {
    ...
    @Override
    public TreeRuleRich queryRuleRich(Long treeId) {
        // 规则树
        ...
        // 树节点 -> 树连接线
        Map<Long, TreeNodeVO> treeNodeMap = new HashMap<>(8);
        List<RuleTreeNode> ruleTreeNodeList = ruleTreeNodeDao.queryRuleTreeNodeList(treeId);
        ruleTreeNodeList.parallelStream().forEach(treeNode -> {
            ...
            if (Constants.NodeType.STEM.equals(treeNode.getNodeType())) {
                ...
                ruleTreeNodeLineReq.setTreeId(treeNode.getTreeId());
                ...
                ruleTreeNodeLineList.forEach(nodeLine -> {
